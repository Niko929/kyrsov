...
class TestCashbackFunctions(unittest.TestCase):
    ...
    def test_main_info(self, mock_get_ccurent, mock_get_top_trans, mock_get_card_with_spend,
                       mock_get_path_and_period, mock_get_data_time, mock_get_time_for_greeting):
        # Arrange
        ...
        mock_get_top_trans.return_value = [{"amount": 100, "category": "Food"}, {"amount": 50, "category": "Transport"}]
